       ...
       do {
           ...
           switch(choix){
               case "1" :
                ...
                case "4":
                        System.out.println("chiffre d'affaire="+ facturation.chiffreAffaire());
                        break;

                case "5":
                        System.out.println("donner le code du client");
                        String code2 = sc.nextLine();
                        facturation.listeFactureClient(code2);
                        break;
                
                case "6":
                        System.out.println("donner le nom du produit");
                        String produit = sc.nextLine();
                        System.out.println("quantite vendue ="+ facturation.quantiteVendue(produit));
                        break;
